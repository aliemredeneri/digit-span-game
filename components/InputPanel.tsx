...
export function InputPanel() {
  ...
  }, [userInput, toRemember, setGameState])
      ...
      <div className="grid grid-cols-3 gap-3 max-w-sm mx-auto">
        {digits.slice(0, 9).map((digit) => (
          <motion.button
            ...
            className="w-24 h-24 bg-white border-2 border-gray-300 rounded-lg text-3xl font-semibold hover:bg-gray-50 transition-colors shadow-md"
        ...
        <motion.button
          ...
          className="w-24 h-24 bg-white border-2 border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50 transition-colors shadow-md"
